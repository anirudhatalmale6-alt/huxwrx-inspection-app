#!/usr/bin/env python3
"""
Build v178 - v177 changes + PO# label prefix on action bar.
...
OUT_MSAPP = os.path.join(WORK, "v178.msapp")
...
PO_LABEL_NEW = b"LayoutMaxWidth: =120\n                                    PaddingLeft: =30\n                                    Text: =\"PO# \" & Coalesce(Text(RecordsGallery1.Selected.'PO Number'), \"\")"
...
json_mod = replace_in_range(json_mod, b'SelectedRecordTitle1', JSON_MAXW_OLD, b'"InvariantScript": "120"', "PO# LayoutMaxWidth")
